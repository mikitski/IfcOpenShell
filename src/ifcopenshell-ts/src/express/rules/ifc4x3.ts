 ...
 * IFC4X3 copy had the exact same raw-arithmetic-on-`INDETERMINATE` bug and is fixed
 * identically here (not itself hit by any of the 8 vendored IFC4X3_ADD2 rule fixtures,
 * but fixed for consistency with the other two byte-identical copies, all three ported
 * from the same real Python source function).
 */
